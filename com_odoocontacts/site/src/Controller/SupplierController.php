...
class SupplierController extends FormController
{
    ...
    public function edit($key = null, $urlVar = null)
    {
        ...
        $this->setRedirect(Route::_('index.php?option=com_odoocontacts&view=supplier&layout=edit&id=' . $supplierId));
        return true;
    }
    ...
    public function add()
    {
        ...
        $this->setRedirect(Route::_('index.php?option=com_odoocontacts&view=supplier&layout=edit&id=0'));
        return true;
    }
    ...
    public function save($key = null, $urlVar = null)
    {
        ...
        if (!Session::checkToken()) {
            ...
            $this->setRedirect(Route::_('index.php?option=com_odoocontacts&view=suppliers'));
            return false;
        }
        ...
        if ($supplierId > 0) {
            $this->app->enqueueMessage(Text::_('COM_ODOOCONTACTS_SUPPLIER_SAVE_NOT_IMPLEMENTED'), 'warning');
        } else {
            $this->app->enqueueMessage(Text::_('COM_ODOOCONTACTS_SUPPLIER_CREATE_NOT_IMPLEMENTED'), 'warning');
        }
    ...
    public function delete()
    {
        ...
        if ($supplierId <= 0) {
            $this->app->enqueueMessage(Text::_('COM_ODOOCONTACTS_ERROR_INVALID_ID'), 'error');
            $this->setRedirect(Route::_('index.php?option=com_odoocontacts&view=suppliers'));
            return false;
        }
        ...
        $this->app->enqueueMessage(Text::_('COM_ODOOCONTACTS_SUPPLIER_DELETE_NOT_IMPLEMENTED'), 'warning');
    ...
    public function getOTESuppliers()
    {
        ...
        if ($user->guest) {
            echo json_encode(['success' => false, 'message' => Text::_('COM_ODOOCONTACTS_ERROR_LOGIN_REQUIRED')]);
            jexit();
        }
