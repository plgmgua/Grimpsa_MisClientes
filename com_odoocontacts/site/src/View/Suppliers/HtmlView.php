...
namespace Grimpsa\Component\OdooContacts\Site\View\Suppliers;
...
/**
 * HTML Suppliers View class for the Odoo Contacts component
 */
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        // Set the title
        $this->document->setTitle(Text::_('COM_ODOOCONTACTS_SUPPLIERS_TITLE'));
        ...
        if ($config->get('enable_debug', 0)) {
            Factory::getApplication()->enqueueMessage('Odoo Suppliers View v1.1.0-BETA loaded', 'info');
    ...
    protected function _prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', Text::_('COM_ODOOCONTACTS_SUPPLIERS_TITLE'));
        }
