...
namespace Grimpsa\Component\OdooContacts\Site\View\Contacts;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar()
    {
        ...
        if ($config->get('enable_debug', 0)) {
            Factory::getApplication()->enqueueMessage('Odoo Contacts Component v1.0.2-STABLE loaded. CSS: contacts.css', 'info');
    ...
    protected function _prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', Text::_('COM_ODOOCONTACTS_CONTACTS_TITLE'));
        }
