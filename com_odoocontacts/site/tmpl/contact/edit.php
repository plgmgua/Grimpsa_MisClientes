...
<div class="odoo-contacts-component">
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <?php if ($parentId > 0): ?>
                        <li class="breadcrumb-item">
                            <a href="<?php echo Route::_('index.php?option=com_odoocontacts&view=contact&layout=edit&id=' . $parentId); ?>">
                                Cliente Principal
                            </a>
                        </li>
                        <?php endif; ?>
    ...
    <form action="<?php echo Route::_('index.php?option=com_odoocontacts&view=contact&layout=edit&id=' . (int) ($this->item->id ?? 0)); ?>" 
                                                ...
                                                <tr class="contact-main-row">
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm" role="group">
                                                            <a href="<?php echo Route::_('index.php?option=com_odoocontacts&view=contact&layout=edit&id=' . (int)($child['id'] ?? 0)); ?>" 
            ...
            <div class="form-actions mt-4" id="formActions" style="display: none;">
                <div class="btn-toolbar" role="toolbar">
                    <div class="btn-group me-2" role="group">
                        <button type="button" class="btn btn-success" onclick="Joomla.submitbutton('contact.save')">
                            <i class="fas fa-save"></i> Guardar
                        </button>
                        <button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('contact.apply')">
                            <i class="fas fa-check"></i> Aplicar
                        </button>
                    </div>
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-secondary" onclick="Joomla.submitbutton('contact.cancel')">
...
function saveChildContact() {
    ...
    childForm.action = '<?php echo Route::_("index.php?option=com_odoocontacts&view=contact"); ?>';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (deleteChildForm) {
        deleteChildForm.action = window.location.href.split('?')[0] + '?option=com_odoocontacts&view=contacts';
    }
});
</script>
